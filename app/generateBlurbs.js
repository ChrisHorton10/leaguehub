const MANAGER_PERSONAS = {
    ...
    "ctracewell": {
      nickname: "Tracewell",
      persona: "Wannabe DJ, Browns fan. His roster is old and not competitive right now — past his window."
    },
    "GrimaceHugeSack": {
      nickname: "Grimace",
    ...
    "Bdug14": {
      nickname: "Dlugos",
      persona: "League villain this year, Browns die-hard, his brothers secretly help him manage his team which is an inside joke in the league."
    },
    "SamHuman12": {
      nickname: "Sam",
  ...
  Write a preseason scouting report blurb for each team. Use your own knowledge of NFL players, their 2026 fantasy projections, ADP, injury history, breakout potential, and bust risk to inform your analysis. Cross reference that with the actual roster provided. If a manager has elite players say so. If their roster is aging or thin at key positions call it out analytically.
  This is the 2026-27 dynasty season. Reference players and situations as they stand heading into the 2026 NFL season.
  Tone is Bill Simmons — witty, honest, personal. Not a roast but sharp commentary that reflects both who these guys are AND what their roster actually looks like based on real football knowledge.
  
  Important rules:
  - Use the nickname, never the team name
  - Lead with football analysis first, personality second
  - Be honest — if the team is bad based on the roster, say it
  ...
  Write a blurb for each team using your knowledge of NFL players — their current form, injury status, usage trends, and fantasy value — combined with the actual roster and record data provided. If a manager's key players are underperforming based on what you know, call it out. If someone has a sneaky good lineup, acknowledge it.
